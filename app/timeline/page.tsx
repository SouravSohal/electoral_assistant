...
export default function TimelinePage() {
  return (
    <div className="min-h-screen flex flex-col selection:bg-[var(--color-brand-saffron)] selection:text-[var(--color-brand-navy)]">
      ...
      <main className="flex-1 container-max pt-24 md:pt-[120px] pb-12 md:pb-20 relative overflow-hidden animate-fade-in-up">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 md:mb-16 relative z-10 px-4">
          <h1 className="text-3xl md:text-5xl lg:text-display mb-4 text-white font-black tracking-tight leading-tight">
            The <span className="text-[var(--color-brand-blue)]">Election</span> Process
          </h1>
          <p className="text-sm md:text-lg lg:text-subheadline text-[var(--color-brand-muted)] max-w-2xl mx-auto leading-relaxed">
