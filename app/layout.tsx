...
export const metadata: Metadata = {
  ...
  description:
    "Empowering Indian citizens with AI-driven election insights. Understand the ECI process, Lok Sabha timelines, and voting steps. Find your polling booth and practice with our EVM simulator.",
  keywords: [
    "ECI India",
    "NVSP",
    "Voter Helpline",
    "Indian Elections 2026",
    "Lok Sabha Voting",
    "Polling Booth Finder India",
    "EVM Simulator",
    "VVPAT Guide",
    "Form 26 Affidavit",
    "Know Your Candidate India",
  ],
