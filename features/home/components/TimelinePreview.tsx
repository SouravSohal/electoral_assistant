    ...
    <section className="py-24 relative overflow-hidden">
      <div className="container-max relative z-10">
        ...
        <div className="max-w-3xl mx-auto mt-16">
          ...
          <div className="relative border-l-2 border-[hsla(210,20%,98%,0.08)] ml-4 md:ml-6 space-y-10 pb-4">
            
            {previewStages.map((stage, index) => (
              <div key={stage.id} className="relative pl-8 md:pl-12 group">
                
                {/* Track Node Indicator */}
                <div className="absolute -left-[17px] top-1.5 flex items-center justify-center w-8 h-8 rounded-full bg-[var(--color-brand-navy)] border-2 border-[hsla(210,20%,98%,0.2)] group-hover:border-[var(--color-brand-saffron)] transition-colors duration-300">
                ...
                {/* Content Card */}
                <div className="glass-panel p-6 md:p-8 rounded-2xl border border-[hsla(210,20%,98%,0.05)] hover:border-[hsla(210,20%,98%,0.15)] hover:bg-[hsla(210,20%,98%,0.03)] transition-all duration-300">
                  <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-4">
                    <div>
                      <div className="flex items-center gap-3 mb-1">
                        <span className="text-xs font-bold text-[var(--color-brand-saffron)] uppercase tracking-widest">
                          Stage {stage.step}
                        </span>
                      </div>
