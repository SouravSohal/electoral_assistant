import { BotMessageSquare, CalendarRange, MapPin, Languages, ShieldCheck, Accessibility } from "lucide-react";

const FEATURES = [
  {
    id: "ai-assistant",
    title: "AI Civic Assistant",
    description: "Ask questions about voter registration, NOTA, and EVMs. Get instant, unbiased answers powered by Gemini.",
  ...
  },
  {
    ...
    description: "All information is strictly cross-referenced with official Election Commission of India guidelines.",
      ...
      <div className="container-max">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {FEATURES.map((feature) => (
            <div 
              key={feature.id} 
              className="group glass-panel p-8 rounded-2xl hover:bg-[hsla(210,20%,98%,0.03)] transition-colors border border-[hsla(210,20%,98%,0.05)] hover:border-[hsla(210,20%,98%,0.15)]"
            >
